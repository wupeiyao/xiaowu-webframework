...
public enum ObjectMimeType {
     ...
     */
    ObjectMimeType(String extension, String explain, String mimeType) {
     ...
     * @return 枚举类
     */
    public static ObjectMimeType getByExtension(String extension) {
        if (StringUtils.isEmpty(extension)) {
            return null;
        }
        for (ObjectMimeType typesEnum : ObjectMimeType.values()) {
    ...
    public static String getContentType(String fileType) {
        ObjectMimeType mimeTypeEnum = ObjectMimeType.getByExtension(fileType);
